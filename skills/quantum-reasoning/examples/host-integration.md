...
```python
from axiomize.reasoning.branch_controller import Branch, BranchMetrics, collapse_decision
...
Use the same model/version, tools, sampling settings and budget policy for both conditions. See [`../../../src/axiomize/reasoning/benchmark/README.md`](../../../src/axiomize/reasoning/benchmark/README.md).
